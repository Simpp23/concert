...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2024 at 04:29 PM
...
(10, 'ds', 5555, 'aaaaaa', '2024-08-07 14:19:52'),
(11, 'freekub', 7811, 'Sim Sim Sim Sim SimS ims SimS simS siS', '2024-08-07 14:22:23');
...
--
ALTER TABLE `tb_concert_tickets`
  MODIFY `concert_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
